...
const EnglishDailyConversation = ({ startedIndex = 0 }) => {
  ...
  let totalCount = TwoHoursQuestionAndAnswers.length;
  let res;
  ...
  const getData = async () => {
    ...
    res = TwoHoursQuestionAndAnswers[index];
  ...
  const speechStart = (
    text = "Let's move to next question",
    flag,
    mode = 0
  ) => {
    // const synth = window.speechSynthesis;
  ...
  return (
    ...
    >
      <div className="flex justify-center items-start mt-[0px] w-full h-[577px]">
        <span className="px-2 mt-3 text-gray-700 bg-white rounded-full ml-4">
          {questionNo}
        </span>
        ...
        <div className="mx-[50px] flex flex-col gap-4 w-full h-[600px] justify-center items-center relative mt-0">
          ...
          {/* image avatars */}
          <div className="flex justify-start  gap-1 items-center mt-44 w-full h-[600px] flex-col">
            {/* first speaker */}
            ...
            overflow-hidden ${
              ...
              <p className="px-2 text-red-600 py-2 rounded text-center text-5xl tracking-wide font-semibold">
                {speaker && speaker === 1 ? (
                  <HighlightedText
          ...
          <div className="flex flex-col gap-3 justify-between w-full mt-1 hidden">
            {/* Explanation */}
            {/* {exp && (
